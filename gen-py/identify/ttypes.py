...
class user_info_st(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'uid', 'UTF8', None, ),  # 1
        (2, TType.STRING, 'groud_id', 'UTF8', None, ),  # 2
        (3, TType.STRING, 'user_info', 'UTF8', None, ),  # 3
    )

    def __init__(self, uid=None, groud_id=None, user_info=None,):
        self.uid = uid
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.groud_id = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.uid is not None:
            ...
            oprot.writeString(self.uid.encode('utf-8') if sys.version_info[0] == 2 else self.uid)
            oprot.writeFieldEnd()
        if self.groud_id is not None:
            oprot.writeFieldBegin('groud_id', TType.STRING, 2)
            oprot.writeString(self.groud_id.encode('utf-8') if sys.version_info[0] == 2 else self.groud_id)
            oprot.writeFieldEnd()
        if self.user_info is not None:
            oprot.writeFieldBegin('user_info', TType.STRING, 3)
...
class db_users(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('db_users')
        if self.users_num is not None:
            oprot.writeFieldBegin('users_num', TType.I32, 1)
            oprot.writeI32(self.users_num)
            oprot.writeFieldEnd()
        if self.user is not None:
            oprot.writeFieldBegin('user', TType.MAP, 2)
            oprot.writeMapBegin(TType.I32, TType.STRUCT, len(self.user))
            for kiter25, viter26 in self.user.items():
